const CACHE='rifa-cliente-v13';
const ARQUIVOS=['./','./index.html','./vencedor.html','./style.css','./app.js?v=11','./vencedor.js?v=11','./firebase-config.js?v=11','./manifest.json?v=11','./icon-192.png','./icon-512.png'];
